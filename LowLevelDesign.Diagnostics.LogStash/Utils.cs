// code from http://snipplr.com/view/15179/adapt-systembitconverter-to-handle-big-endian-network-byte-ordering-in-order-to-create-number-types-from-bytes-and-viceversa/
...
namespace LowLevelDesign.Diagnostics.LogStash
{
    ...
    {
        public static void WriteAllBytes(this Stream stream, byte[] b)
        {
    ...
    public static class BigEndianBitConverter
    {
        ...
        ///     architecture.
        ///</summary>
        private readonly static bool IsLittleEndian = false;
